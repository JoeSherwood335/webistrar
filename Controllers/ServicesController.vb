...
Public Class ServicesController
    ...
    Function Edit(ByVal id As Integer) As ActionResult
        ...
        If x.ServiceOutcomeId.HasValue Then
            Throw New ServiceNotUpdateableException(x)
        End If
    ...
    Function Edit(ByVal id As Integer, ByVal collection As FormCollection) As ActionResult
        ...
        If x.ServiceEndDate.HasValue And x.ServiceStartDate.HasValue Then
            If x.ServiceEndDate.Value < x.ServiceStartDate.Value Then
    ...
    <Authorize(Roles:="ServiceEdit")> _
<AcceptVerbs(HttpVerbs.Post)> _
Function Created(ByVal id As Integer, ByVal collection As FormCollection) As ActionResult
        Dim x = _dc.GetService(id)
    ...
    End Function
    <Authorize(Roles:="ResetService")> _
Function ResetService(ByVal id As Integer) As ActionResult
        ...
        If Not x.ServiceOutcomeId.HasValue Then
    ...
    <Authorize(Roles:="ResetService")> _
    <AcceptVerbs(HttpVerbs.Post)> _
    Function ResetService(ByVal id As Integer, ByVal collection As FormCollection) As ActionResult
        Dim x = _dc.GetService(id)
        Try
            x.ud = Date.Now
    ...
    End Function
    <Authorize(Roles:="ServiceView")> _
    Function NewServices(ByVal Search As String, ByVal Sort As String, ByVal dir As String, ByVal Page? As Integer) As ActionResult

        Dim y = _GetServiceList(Search, Sort)
        ...
        Return View(y.ToList.Where(Function(e) e.GetStatus = Model.Service.Statuses.New).ToPagedList(_pageValue, 20))
    End Function
    <Authorize(Roles:="ServiceView")> _
    Function Pending(ByVal Search As String, ByVal Sort As String, ByVal dir As String, ByVal Page? As Integer) As ActionResult
        Dim y = _GetServiceList(Search, Sort)
        ...
        Return View(y.ToList.Where(Function(e) e.GetStatus = Model.Service.Statuses.Pending).ToPagedList(_pageValue, 20))
    End Function
    <Authorize(Roles:="ServiceView")> _
    Function InProgress(ByVal Search As String, ByVal Sort As String, ByVal dir As String, ByVal Page? As Integer) As ActionResult
        ...
        Return View(y.ToList.Where(Function(e) e.GetStatus = Model.Service.Statuses.InProgress).ToPagedList(_pagevalue, 20))

    End Function

    Function _GetServiceList(ByVal Search As String, ByVal Sort As String) As System.Linq.IQueryable(Of Model.Service)

        Dim y = From a In _dc.GetServices _
        ...
        If Not String.IsNullOrEmpty(Search) Then
            ...
            For Each s In Search.Split(" ")
                ...
                Dim x = _dc.GetServices(s).Select(Function(e) e.ServiceId).Take(200)
                y = y.Where(Function(e) x.Contains(e.ServiceId) And e.AssignedTo = Myapp.UserId(True)) '.Take(200)
            Next
        End If

        If Not String.IsNullOrEmpty(Sort) Then
            If Sort = "Name" Then
                y = y.OrderBy(Function(e) e.Authorization.Referral.Info.LastName).OrderBy(Function(e) e.Authorization.Referral.Info.FirstName)
            ElseIf Sort = "aDates" Then
                y = y.OrderBy(Function(e) e.SchedualEndDate)
            ElseIf Sort = "sDates" Then
                y = y.OrderBy(Function(e) e.ServiceEndDate)
            End If
        Else
            y = y.OrderBy(Function(e) e.SchedualEndDate)
        End If
    ...
    'End Function
    <Authorize(Roles:="ServiceView")> _
    Function Completed(ByVal Search As String, ByVal Sort As String, ByVal dir As String, ByVal Page? As Integer) As ActionResult
        ...
        Return View(y.ToList.Where(Function(e) e.GetStatus = Model.Service.Statuses.Completed).ToPagedList(_pageValue, 20))
    End Function
    ...
    Function TimeWorked(ByVal id As Integer) As ActionResult
        ...
        If service.ServiceOutcomeId.HasValue Then
            Throw New ServiceNotUpdateableException(service)
        End If
    ...
    Function Complete(ByVal id As Integer) As ActionResult
        ...
        Dim listofthisservice110inaccre = dc.Billings.Where(Function(a) a.BillingCycles.OrderByDescending(Function(e) e.ActionDate).Select(Function(e) e.Action.Name).First = Myapp.ACCRUED And a.BillingDetails.Any(Function(f) f.ServiceId = id))

        Dim listofthisservice110NotVoided = dc.Billings.Where(Function(a) a.BillingCycles.OrderByDescending(Function(e) e.ActionDate).Select(Function(e) e.Action.Name).First <> Myapp.VOID And a.BillingDetails.Any(Function(f) f.ServiceId = id))
        ...
        If listofthisservice110inaccre.Count > 0 Then
            Throw New BillsInAcrueException(x)

        End If


        If listofthisservice110NotVoided.Count = 0 Then
            Throw New ServiceNotBilledBeforeCompletedException(x)
    ...
    Function Cancel(ByVal id As Integer, ByVal collection As FormCollection) As ActionResult
        ...
        'If x.ServiceEndDate.HasValue = False Then
        '    Throw New ServiceEndDateCantBeNullException(x)
        'End If
        ...
        If x.ServiceStartDate.HasValue = False Then
            x.ServiceStartDate = collection("ServiceStartDate")
        End If
        If x.ServiceEndDate.HasValue = False Then
            x.ServiceEndDate = collection("ServiceStartDate")
        End If
    ...
    Function Accrue(ByVal id As Integer)
        ...
        End If
        If service.GetStatus <> Model.Service.Statuses.InProgress Then
    ...
    Function Manual(ByVal id As Integer)
        ...
        If service.Authorization.Referral.StatusId = Model.Referral.Statuses.Closed Then
            Throw New ServiceNotUpdateableException(service)
        End If

        If service.GetStatus = Model.Service.Statuses.Completed Then
            Throw New ServiceNotUpdateableException(service)
        End If
